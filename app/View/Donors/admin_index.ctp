<div class="donors index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('minecraft_username'); ?></th>
	...
	<tr>
		<td><?php echo h($donor['Donor']['id']); ?>&nbsp;</td>
		<td><?php echo h($donor['Donor']['name']); ?>&nbsp;</td>
		<td><?php echo h($donor['Donor']['minecraft_username']); ?>&nbsp;</td>
		<td><?php echo h($donor['Donor']['email']); ?>&nbsp;</td>
		<td><?php echo h($donor['Donor']['created']); ?>&nbsp;</td>
		<td><?php echo h($donor['Donor']['modified']); ?>&nbsp;</td>
		<td class="actions">
